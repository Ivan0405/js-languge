...
// }};
// console.log(`circle=${circle.square()},perimeter=${circle.perimeter()}`);
...
/******************************** */
Array.prototype.filter = function(callbacPredicate){
        console.log('Tel-ran copyright')
        const res = []
        this.forEach((n, i, a) => !callbacPredicate(n, i, a) && res.push(n));
        return res;
}
